<?php
/**
 * File per la visualizzazione dei risultati della query di un singolo post con titolo sovrapposto ad immagine
 *
 */
...
function Post_single_title_overlying($temp_query){
	$html = '';
	...
	if ( $temp_query->have_posts() ){
		...
		while ( $temp_query->have_posts() ) {
			...
			$html .=  '<div class=" fmadvq-single-post-overlay fmadvq-flex">';
